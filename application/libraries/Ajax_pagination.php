...
class Ajax_pagination{
    ...
    function create_links(){
        ...
        // if ($num_pages == 1){
        //     $info = '<span>Showing : ' . $this->total_rows;
        //     return $info;
        // }
    ...
    function getAJAXlink($count, $text) {
        ...
        //IF THIS POST IS NOT EMPTY, PAGINATION IS USED FOR /SEARCH PAGE
        if(!empty($_POST['filter_products'])){
            //POST['ORDER_BY'] IS NOT EMPTY IF PRODUCTS ARE ORDERED BY PRICE OR RATING
            if(!empty($_POST['order_by'])){
                return '<a class="page_btn" href="javascript:void(0);"' . $this->anchor_class . ' onclick="getProducts('.$pageCount.',&apos;'.$_POST['order_by'].'&apos;)">'. $text .'</a>';
            } else {
                 return '<a class="page_btn" href="javascript:void(0);"' . $this->anchor_class . ' onclick="getProducts('.$pageCount.')">'. $text .'</a>';
            }
             
        }
        return '<a class="page_btn" href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.','.$filter.')">'. $text .'</a>';
